#ifndef SIMULATOR_VEHICLE_MODEL_ROS_H
#define SIMULATOR_VEHICLE_MODEL_ROS_H
...
public:
   ...
   */
  void setVehicleCmd(const common_msgs::SystemOverallConstPtr& msg);
...
#endif  // SIMULATOR_VEHICLE_MODEL_ROS_H

 ...
 */
void convertWaypointsToMPCTraj(const common_msgs::Trajectory &path, MPCTrajectory &mpc_traj);
 ...
 */
void convertWaypointsToMPCTrajWithResample(const common_msgs::Trajectory &path, const std::vector<double> &path_time,
 ...
 * @param [out] ref_traj converted reference trajectory
 */
void convertWaypointsToMPCTrajWithDistanceResample(const common_msgs::Trajectory &path, const std::vector<double> &path_time,
 ...
 * @param [out] ref_traj converted reference trajectory
 */
void convertWaypointsToMPCTrajWithTimeResample(const common_msgs::Trajectory &path, const std::vector<double> &path_time,
 ...
 */
void calcPathRelativeTime(const common_msgs::Trajectory &path, std::vector<double> &path_time);
